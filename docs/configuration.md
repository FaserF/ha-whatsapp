...
The WhatsApp Addon can be configured via the **Configuration** tab in the Home Assistant Addon store.
...
| `mark_online` | boolean | `false` | If true, marks your account as "Online" while the addon is running. |
