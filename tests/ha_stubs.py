...
class DataUpdateCoordinator(_DataUpdateCoordinatorBase):  # type: ignore[valid-type, misc]
...
class CoordinatorEntity(_CoordinatorEntityBase):  # type: ignore[valid-type, misc]
